...
CREATE TABLE `courseAssignment` (
  ...
  `takenSeats` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`courseId`),
  KEY `semseterIndex` (`semesterId`),
  CONSTRAINT `FK_course_asg` FOREIGN KEY (`courseId`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `courseInstructorAssignment`
--

DROP TABLE IF EXISTS `courseInstructorAssignment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `courseInstructorAssignment` (
  ...
  KEY `InstructorSemesterIndex` (`semesterId`),
  KEY `FK_cia_ins_idx` (`instructorId`),
  CONSTRAINT `FK_cia_course` FOREIGN KEY (`courseId`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_cia_ins` FOREIGN KEY (`instructorId`) REFERENCES `instructors` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-26 17:01:20
